...
public:
	 ...
	 */
	static const double ADJUST_RATIO_DOUBLE_ZERO = 1e-10;     //ZY  1e-40;
	static const double ADUJST_RATIO_DOUBLE = 1e-10;         //ZY  1e-40;
	 ...
	 * (sqrt(5)-1)/(sqrt(5)+1)
	 * */
	static const double GoldenPointRatio = 0.38196601125010515;
