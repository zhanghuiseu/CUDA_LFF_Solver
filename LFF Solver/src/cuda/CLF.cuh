	 ...
	 *  2 : case1: abs(y1-y2)<=doubleMin && y1 <0 && y2<0        无解
	 *  4 ： case2: abs(y1-y2)>doubleMin && z>x1 && z<x2 && y1>0 (x1,z)
	 *  8 ： case3: abs(y1-y2)>doubleMin && z>x1 && z<x2 && y2>0 (z,x2)
	 *  16： case4: abs(y1-y2)>doubleMin && z<x1 && y1 <0 && y2<0 无解(xbefore,d)
	 *  32： case5: abs(y1-y2)>doubleMin && z>x2 && y1 <0 && y2<0 无解(d,xafter)
	 *  下面是所有的分类的变量的设置
	 * */
	//全区间case:等式、不等式、全在上方
