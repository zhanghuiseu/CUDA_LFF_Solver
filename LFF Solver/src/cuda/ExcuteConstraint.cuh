	 ...
	 * 第0个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_0_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第1个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_1_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第2个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_2_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第3个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_3_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第4个约束在第0个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_4_0(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第4个约束在第1个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_4_1(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第4个约束在第2个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_4_2(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第4个约束在第3个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_4_3(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第4个约束在第4个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_4_4(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第4个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_4_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第5个约束在第0个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_5_0(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第5个约束在第1个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_5_1(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第5个约束在第2个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_5_2(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第5个约束在第3个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_5_3(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第5个约束在第4个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_5_4(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第5个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_5_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第6个约束在第0个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_6_0(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第6个约束在第1个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_6_1(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第6个约束在第2个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_6_2(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第6个约束在第3个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_6_3(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第6个约束在第4个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_6_4(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第6个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_6_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第7个约束在第0个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_7_0(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第7个约束在第1个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_7_1(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第7个约束在第2个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_7_2(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第7个约束在第3个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_7_3(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第7个约束在第4个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_7_4(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第7个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_7_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第8个约束在第0个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_8_0(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第8个约束在第1个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_8_1(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第8个约束在第2个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_8_2(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第8个约束在第3个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_8_3(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第8个约束在第4个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_8_4(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第8个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_8_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
	 ...
	 * 第9个约束在第0个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_9_0(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第9个约束在第1个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_9_1(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第9个约束在第2个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_9_2(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第9个约束在第3个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_9_3(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第9个约束在第4个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_9_4(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);

	/*
	 * 第9个约束在第5个搜索方向的执行
	 * */ 
	__global__ void calaConstraint_0_9_5(CoodinateDouble* dev_predictArray,double* dev_parameter,const int base,const int calaMatCol);
