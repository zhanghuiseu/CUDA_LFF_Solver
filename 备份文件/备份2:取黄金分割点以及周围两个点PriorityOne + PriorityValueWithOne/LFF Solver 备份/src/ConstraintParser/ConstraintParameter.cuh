...
public:
	 ...
	 * 目标约束的参数数量
	 * */ 
	static const int NUM_OF_PARAM = 5;
	 ...
	 * 所有的约束的数量
	 * */ 
	static const int Num_Of_Constraints = 4;
	 ...
	 * */ 
	static RuntimeValue* getConstraintValue_0_0(double x , double y , double z , double w , double v);
	static RuntimeValue* getConstraintValue_0_1(double x , double y , double z , double w , double v);
	static RuntimeValue* getConstraintValue_0_2(double x , double y , double z , double w , double v);
	static RuntimeValue* getConstraintValue_0_3(double x , double y , double z , double w , double v);
};
