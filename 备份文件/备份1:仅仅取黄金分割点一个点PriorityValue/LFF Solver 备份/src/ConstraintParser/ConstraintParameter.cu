	 ...
	 * 
	 * ***************   Notice   ***************
	 * Auto Generated By ATPC on:2017-11-19 16:52:14
	 * Author: ZhangHui
	 * 
	 */ 
	 ...
	 * 约束的名字信息
	 * */ 
	string ConstraintParameter::constraintName = "TestBenchmark01";
	...
	vector< vector<RuntimeValue*> > ConstraintParameter::getCoveredInfo(double* nums)
	{
		...
		RuntimeValue* tmp_0_0 = getConstraintValue_0_0(nums[0] , nums[1] , nums[2]);
		HeQv1.push_back(tmp_0_0);
		RuntimeValue* tmp_0_1 = getConstraintValue_0_1(nums[0] , nums[1] , nums[2]);
		HeQv1.push_back(tmp_0_1);
		RuntimeValue* tmp_0_2 = getConstraintValue_0_2(nums[0] , nums[1] , nums[2]);
